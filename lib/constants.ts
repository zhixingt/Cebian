...
- **read_page**: Extract page content via DOM (modes: text, markdown, html, article, outline). Use when smart_read_page is not applicable or when you need article-style extraction.
